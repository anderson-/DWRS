...
import s3f.dwrs.robot.action.system.StopAll;
import s3f.dwrs.robot.action.system.UpdateAllDevices;
 ...
 * @author antunes
 */
public class Robot extends SimpleElement implements Observer<ByteBuffer, Connection>, GraphicObject, Rotable {
    ...
    public void save(FileCreator fileCreator) {
        fileCreator.makeTextFile(getName(), getCategoryData().getExtension(), new StringBuilder());
    }
...
//            System.out.println("Tempo do ciclo: " + stepTime);
    ...
    public Robot() {
        ...
        {//teste
            ...
            virtualConnection.establishConnection();
            setMainConnection(virtualConnection);
            virtualConnection.setRobot(this);
            //add(new LED());
        }
    }
