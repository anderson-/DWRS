...
public class ReadDevice extends Procedure implements GraphicResource, Classifiable, FunctionToken<ReadDevice> {
    ...
    private static MutableWidgetContainer createDrawableMove(final ReadDevice rd) {
        ...
        List<Device> list = em.getAllProperties("s3f.dwrs.device.*", "device", Device.class);
        for (Device d : list) {
            deviceMap.put(d.getName(), d.getClass());
            System.out.println("put: " + d.getName() + " " + d.getClass());
...
//        }
        ...
        final WidgetLine headerLine = new WidgetLine() {
            ...
            public void toString(StringBuilder sb, ArrayList<Argument> arguments, MutableWidgetContainer container) {
                ...
                System.out.println("search for " + rd.arg0.toString());
                rd.type = deviceMap.get(rd.arg0.toString());
                System.out.println("find: " + rd.type);
            }
        };
